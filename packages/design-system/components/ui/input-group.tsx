...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y: The div preserves composite input layout while exposing grouped controls.
    <div
      className={cn(
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y: Clicking addon whitespace forwards focus to the grouped input; keyboard users focus the input/control directly.
    <div
